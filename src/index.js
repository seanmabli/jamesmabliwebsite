    ...
    <div style={{display: "flex", justifyContent: "center"}}>
      <div className="site">
        ...
        <p>
          ...
          <a href="https://mathematica.org/">Mathematica</a> specializing in
          food and nutrition policy and employment and training programs. My
          research focuses on federal nutrition assistance programs, including
          the Supplemental Nutrition Assistance Program (SNAP) and the Older
          Americans Act Title III-C Nutrition Services Program, as well as
          community-based emergency food programs. Much of my work focuses on
          low-income households' decisions to participate in these programs, to
          find and retain employment, and to address barriers to ensuring job
          security and adequate access to food.
        </p>
        <br />
        <p>
          I currently oversee two employment and training (E&T) evaluations
          funded by the Food and Nutrition Service: a rapid cycle evaluation of
          operational improvements in SNAP E&T which is testing up to eight
          small-scale interventions in operations or service delivery and a
          large ten-state random assignment evaluation of innovative strategies
          to help SNAP participants increase employment, earnings, and food
          security and decrease use of public assistance. I am also leading a
          process evaluation of the Aging Network for the U.S. Department of
          Health and Human Services that examines network agencies' return on
          investment of the services they provide to older adults related to
          congregate and home-delivered meals, transportation, socialization,
          and community health and family caregiving. My recent work also
          includes evaluations of interventions for childhood obesity and
          studies of geographic access to food for low-income families.
        </p>
        <br />
        <h2 id="research">Research</h2>
        <br />
        <p>
          "Food Insecurity is Directly Associated with the Use of Health
          Services for Adverse Health Events Among Older Adults" (with Ariella
          Kahn-Lang Spitzer and Marisa Shenk) (
        ...
        <p>
          ...
          Examination of Social Activities at Congregate Meal Sites and Their
          Role in Improving Socialization Outcomes of Participants", January
          2019{" "}
          <a
            className="bold"
        ...
        <br />
        <p>
          "Needs of and Service Use Among Participants in the Older Americans
          Act Title III-C Nutrition Services Program", November 2018{" "}
          <a
            className="bold"
        ...
        <br />
        <p>
          "The Impact of Healthy Harlem on Student Fitness Outcomes after Two
          and Three Years"{" "}
          <a
            className="bold"
        ...
        <br />
        <p>
          "Examination of the Effect of SNAP Benefit and Eligibility Parameters
          on Low Income Households" October 2017{" "}
          <a
            className="bold"
        ...
        <br />
        <p>
          "The Impact of Healthy Harlem on the Prevalence of Child Overweight
          and Obesity and Contributing Factors: Interim Evaluation Report"
          September 2017{" "}
          <a
            className="bold"
        ...
        <p>
          ...
          (with Luca Flabbi and Mario Salazar) (
        ...
        <p>
          ...
          <span className="italic">American Journal of Public Health</span>,
          June 2015{" "}
          <a
            className="bold"
        ...
        <br />
        <p>
          "Testimony for U.S. House of Representatives Hearing on the
          Supplemental Nutrition Assistance Program." February 2015.{" "}
          <a
            className="bold"
        ...
        <br />
        <p>
          "Determinants of Supplemental Nutrition Assistance Program
          Participation from 2008 to 2012." December 2014.{" "}
          <a
            className="bold"
        ...
        <br />
        <p>
          "Supplemental Nutrition Assistance Program Participation and Child
          Food Security" (with Julie Worthington) Pediatrics. 2014, 113(4):
          1-10.{" "}
          <a
            className="bold"
        ...
        <p>
          ...
          Assistance Program Participants and Other Low-Income Americans" (with
          Rosalie Malsberger){" "}
          <span className="italic">Monthly Labor Review</span>. September 2013{" "}
          <a
            className="bold"
            href="https://www.bls.gov/opub/mlr/2013/article/mabli-malsberger.htm"
          >
            [pdf]
          </a>
        </p>
        ...
        <p>
          ...
          Emergency Food Pantries in Areas without Supermarkets" (with David
          Jones and Phillip Kaufman){" "}
          <span className="italic">
            Journal of Hunger & Environmental Nutrition
          </span>
          . Vol 8, Issue 3, 2013{" "}
        ...
        <p>
          ...
          in Measures of Unemployment, Labor Underutilization, and Program
          Policy from 2000 to 2008"{" "}
          <a
            className="bold"
            href="https://www.mathematica.org/publications/supplemental-nutrition-assistance-program-caseload-trends-and-changes-in-measures-of-unemployment-labor-underutilization-and-program-policy-from-2000-to-2008"
          >
            [pdf]
          </a>
        </p>
        ...
        <p>
          ...
          <a
            className="bold"
            href="https://www.mathematica.org/publications/hunger-in-america-2010-national-report-prepared-for-feeding-america"
          >
            [pdf]
          </a>
        </p>
        ...
        <p>
          ...
          <a
            className="bold"
            href="https://www.mathematica.org/publications/analysis-of-transition-events-in-health-insurance-coverage"
          >
            [pdf]
          </a>
        </p>
        ...
        <p>
          ...
          <a
            className="bold"
            href="https://www.mathematica.org/publications/wic-eligibles-and-coverage-19942007-estimates-of-the-population-of-women-infants-and-children-eligible-for-wic-benefits"
          >
            [pdf]
          </a>
        </p>
        ...
        <p>
          ...
          <a
            className="bold"
            href="http://www.rwjf.org/content/dam/farm/reports/reports/2009/rwjf35004"
          >
            [pdf]
          </a>
        </p>
        ...
        <p>
          ...
          <a
            className="bold"
            href="https://www.mathematica.org/~/media/publications/PDFs/samplelosssurvey.pdf"
          >
            [pdf]
          </a>
        </p>
        ...
        <p>
          ...
          <a
            className="bold"
            href="https://www.fns.usda.gov/snap/dynamics-food-stamp-program-participation-2001-2003"
          >
            [pdf]
          </a>
        </p>
